...
// ── §8: wait for DOM ──────────────────────────────────────────────────────────
// NOTE: no in-engine exit / close button. The native container app (RN WebView,
// iOS WKWebView, Android WebView) owns the exit affordance and overlays its
// own close control above the WebView.
